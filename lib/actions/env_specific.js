...
EnvSpecific.prototype.processFile = function(filepath) {
	...
	for (var i = 0; i < matches.length; i++) {
		...
		//	delete non-active files unless they match the target filename
		//	allows having eg .htaccess and .htaccess.production
		if (matches[i] !== realPath) {
	...
	this.fileChanges.keepFile(realPath);
}
